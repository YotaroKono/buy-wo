...
export default function LogoAnimation() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // スクリプトが存在するかチェック
      let existingScript = document.getElementById('anime-js-script');
      if (!existingScript) {
  ...
  useEffect(() => {
    ...
    if (!isAnimationReady || !svgRef.current || typeof window === 'undefined' || !window.anime) return;
    ...
    const timeoutId = setTimeout(() => {
      try {
        ...
        if (!logoSquare || !logoCircle || !logoLetters || logoLetters.length === 0) {
      ...
      >
        <defs>
          <clipPath id="square-clip">
            <path d="M 84.117188 30.527344 L 97.855469 30.527344 L 97.855469 44.265625 L 84.117188 44.265625 Z M 84.117188 30.527344 " clipRule="nonzero" />
          </clipPath>
          <clipPath id="square-inner-clip">
            <path d="M 90.984375 30.527344 L 97.855469 37.398438 L 90.984375 44.265625 L 84.117188 37.398438 Z M 90.984375 30.527344 " clipRule="nonzero" />
          </clipPath>
          <clipPath id="dot-clip">
            <path d="M 55.066406 35.535156 L 58.9375 35.535156 L 58.9375 39.257812 L 55.066406 39.257812 Z M 55.066406 35.535156 " clipRule="nonzero" />
          </clipPath>
        </defs>
