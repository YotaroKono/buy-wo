...
export class AuthTokens {
  ...
  withUpdatedAccessToken(newAccessToken: AccessToken): AuthTokens {
    return new AuthTokens(newAccessToken, this.supabaseToken, this.refreshToken);
  }
  ...
  withUpdatedSupabaseToken(newSupabaseToken: SupabaseToken): AuthTokens {
    return new AuthTokens(this.accessToken, newSupabaseToken, this.refreshToken);
  }
  ...
  withUpdatedRefreshToken(newRefreshToken: RefreshToken | null): AuthTokens {
    return new AuthTokens(this.accessToken, this.supabaseToken, newRefreshToken);
  }
